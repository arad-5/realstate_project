    ...
    return (
        <>
            <svg
                ...
                className='absolute z-30 m-3 w-28 cursor-pointer rounded-2xl bg-white text-3xl font-bold'
                viewBox='0 0 100 100'
            >
                <path
                    fill='currentColor'
            ...
            <div className='relative left-1/2 h-screen w-screen -translate-x-1/2'>
                <Image
                    ...
                    priority
                />
                <div className='absolute top-0 left-0 h-full w-full bg-gradient-to-t from-white via-transparent to-transparent'></div>
            </div>
            <section className='-mt-[30vh]'>
                <div className='relative mb-8 grid gap-3 sm:grid-cols-2 md:gap-5 lg:grid-cols-3 xl:grid-cols-4'>
                    <div className='absolute -top-20 z-10 w-full text-center text-2xl'>
                        <h1 className='inline-block rounded-full border bg-white px-3 py-1'>
                            🔥properties for sale
                        </h1>
                    </div>
