...
const NavMenu = () => {
    ...
    return (
        <>
            ...
            <div
                className={`absolute left-0 top-16 w-screen origin-top overflow-hidden rounded-b-3xl border-b bg-white/50 pt-5 backdrop-blur-lg transition-transform dark:border-neutral-700 dark:bg-[#171717]/50 lg:static lg:h-full lg:w-auto lg:rounded-none z-50 lg:border-0 lg:py-0 ${
                    menuOpen ? 'scale-y-100' : 'scale-y-0'
                } lg:scale-100`}
            >
                <ul className='h-full font-hanson tracking-wider lg:flex'>
                    <li className='flex h-full text-md dark:text-white'>
                    ...
                    <li className='flex h-full border-y text-md dark:border-neutral-700 dark:text-white lg:border-0'>
