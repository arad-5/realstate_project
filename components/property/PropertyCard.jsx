...
const PropertyCard = ({
    ...
    return (
        <Link href={`/property?id=${externalID}`} passHref>
            <div className="property-card relative z-10 cursor-pointer border-b p-3 py-6 last:border-b-0 dark:border-neutral-700 dark:bg-[#202020] sm:mt-20 sm:rounded-2xl sm:border-0 sm:shadow-lg sm:hover:-translate-y-3 sm:hover:shadow-xl">
                ...
                <div className="text-md flex items-center justify-between overflow-hidden pt-2 dark:border-[#404040] sm:border-t">
