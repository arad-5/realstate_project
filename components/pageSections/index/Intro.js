    ...
    return (
        <section>
            <div className='relative left-1/2  h-screen w-screen -translate-x-1/2'>
                <div className='relative z-50 flex h-full w-1/2 flex-col items-center justify-center rounded-tr-[15vw] bg-white after:absolute after:-right-[15vw] after:bottom-0 after:-z-10 after:h-[15vw]  after:w-[15vw] after:rounded-bl-full after:shadow-[-100px_100px_0_100px_white] dark:bg-neutral-900 after:dark:shadow-[-100px_100px_0_100px_#171717]'>
                    <div>
                        <div className='mb-4'>
                ...
                <div className='absolute right-0 top-0 -z-10 h-full md:w-4/6'>
