...
const Intro = () => {
    return (
        <section >
            <div className='relative left-1/2 overflow-y-hidden h-screen w-screen -translate-x-1/2'>
                ...
                <div className='relative -mt-[20vh] flex h-1/2 flex-col items-center justify-center rounded-tr-[20vh] bg-white after:absolute after:left-0 after:-top-[20vh] after:-z-10  after:h-[20vh] after:w-[20vh] after:rounded-bl-full after:shadow-[-15vw_15vw_0_15vw_white] after:transition-colors dark:bg-neutral-900 after:dark:shadow-[-15vw_15vw_0_15vw_#171717] sm:mt-0 sm:h-full sm:w-1/2 sm:rounded-tr-[15vw] after:sm:bottom-0 after:sm:top-auto after:sm:left-auto after:sm:-right-[15vw] after:sm:h-[15vw] after:sm:w-[15vw]'>
                    
                </div>
                <div className='container absolute left-1/2 top-0 flex h-full w-screen -translate-x-1/2 items-end sm:justify-start justify-center py-[5vh] sm:items-center sm:px-14'>
                    <div className='relative w-full sm:w-auto px-2 sm:bg-white sm:dark:bg-[#171717] sm:p-10 rounded-3xl'>
                        <div className='mb-5'>
                            <DarkmodeSwitch />
                        </div>
